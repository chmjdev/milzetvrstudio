...
run([compiler,'-nologo','-out:Artifacts/reader-smoke.exe','-r:System.Runtime.Serialization.dll','-r:System.Xml.Linq.dll','Unity/Assets/Milzet/Runtime/PackageReader.cs','Unity/Assets/Milzet/Runtime/PcmWave.cs','Unity/Assets/Milzet/Runtime/Projection.cs','Unity/Tests/ReaderSmoke.cs']);
...
if(existsSync('Artifacts/authored-browser.milzet-package.json')) {
 run([compiler,'-nologo','-out:Artifacts/authored-smoke.exe','-r:System.Runtime.Serialization.dll','-r:System.Xml.Linq.dll','Unity/Assets/Milzet/Runtime/PackageReader.cs','Unity/Assets/Milzet/Runtime/PcmWave.cs','Unity/Assets/Milzet/Runtime/Projection.cs','Unity/Tests/AuthoredSmoke.cs']);
