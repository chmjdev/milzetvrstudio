...
run([compiler,'-nologo','-out:Artifacts/reader-smoke.exe','-r:System.Runtime.Serialization.dll','-r:System.Xml.Linq.dll','Unity/Assets/Milzet/Runtime/PackageReader.cs','Unity/Assets/Milzet/Runtime/PcmWave.cs','Unity/Assets/Milzet/Runtime/Projection.cs','Unity/Assets/Milzet/Runtime/Mp4Video.cs','Unity/Assets/Milzet/Runtime/ModelContract.cs','Unity/Assets/Milzet/Runtime/ActivityContract.cs','Unity/Assets/Milzet/Runtime/ScenarioContext.cs','Unity/Tests/ReaderSmoke.cs']);
