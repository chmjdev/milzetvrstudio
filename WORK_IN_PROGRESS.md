...
3. **Immersion — decided 2026-09-15: "both, 360 first."** The wearer saw flat stills/video on the headset and asked for an immersive walk-in experience. The runtime already plays genuine 180/360 spheres with in-world hotspots; what is missing is immersive content.
   ...
   - **Interim immersive demo — done 2026-09-15.** Seven Wikimedia Commons spheres (ESO ELT site entrance CC BY; Poly Haven interior CC0; Lauri Veerde's Iru control room, turbine hall, TalTech seminar room, EASS safety lab and main entrance, CC BY-SA 4.0) downloaded with SHA-1 verification, resized to 8192×4096 (assembly point cropped to a 7680×7680 front hemisphere, labelled `equirect180`), sealed by `scripts/build-commons-360.mjs` as packs 12–18 with full provenance, and pushed to the headset. Wearer check of the sphere experience pending. Native verification extended 2026-09-16: the rebuilt 1.2.0 Mac player walks all twelve packs (`native-verification.json`: packages 12, immersive 7, activities 34, video advanced) and the sphere renders were inspected. `pilot-checks.mjs` now accepts a 360° plate for the 180° source requirement (relabelled '180° or 360°', tested); with that, the trench scenario reads complete on the sphere packs. Still unsatisfied by design — onsite captures: the toolbox-talk 90 s mentor WAV, the site-log walkthrough video, six first-aid stills; and the virtual-assessment external stream reference, which is CareerWIL's.
