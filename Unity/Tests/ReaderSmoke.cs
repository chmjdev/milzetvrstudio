...
class ReaderSmoke {
 static int Main(string[] args) {
  ...
  if(accepted!=1)return 2;Console.WriteLine("PASS: native C# reader loaded fixture media and four hotspots; authored subset, host gate and completion/evidence events verified.");return 0;
 }
}
