...
function App() {
  ...
  return <div className="shell">
    ...
    <main><header><div><span className="eyebrow">INTERACTIVE / MILZET</span><h1>Content workspace</h1></div><span className="badge">Foundation · local drafts</span></header>
      ...
      <p role="status" className="status">{message}</p><footer><span>Client content stays separate from the application.</span><span>Milzet VR Studio · 0.1</span></footer>
    </main>
  </div>;
}
